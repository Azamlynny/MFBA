...
class PlayerTracker():
    ...
    def __init__(self):
        self.players = []
        # Team A
        self.players.append(Sanservino(xPos = 100, yPos = 4500, wd = 50, ht = 50, strength = 5, speed = 12, hp = 250, hpMax = 250, hpRegen = 250, atk = 60, atkSpeed = 4.0, armor = 3, atkRange = 100, alliance = "a", visionRange = 700, atkType = "melee"))
        ...
        # Team B
        self.players.append(Player(xPos = 100, yPos = 4500, wd = 70, ht = 70, strength = 5, speed = 3, hp = 450, hpMax = 500, hpRegen = 5, atk = 20, atkSpeed = 1.0, armor = 3, atkRange = 100, alliance = "b", visionRange = 500, atkType = "melee"))        
