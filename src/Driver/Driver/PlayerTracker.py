...
class PlayerTracker():
    ...
    def __init__(self):
        self.players = []
        self.players.append(Fang(xPos = 50, yPos = 50, wd = 50, ht = 50, strength = 5, speed = 6, hp = 250, hpMax = 250, hpRegen = 1.5, atk = 5, atkSpeed = 2.0, armor = 3, atkRange = 350, alliance = "a", visionRange = 700, atkType = "ranged"))
