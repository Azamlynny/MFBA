...
class PlayerTracker():
    ...
    def __init__(self):
        self.players = []
        # Team A
        self.players.append(Fang(xPos = 100, yPos = 4500, wd = 50, ht = 50, strength = 5, speed = 12, hp = 250, hpMax = 250, hpRegen = 250, atk = 60, atkSpeed = 20.0, armor = 3, atkRange = 250, alliance = "a", visionRange = 700, atkType = "ranged"))
