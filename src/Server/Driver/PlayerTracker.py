...
class PlayerTracker():
    ...
    def __init__(self):
        ...
        self.players.append(Player(xPos = 4000, yPos = 500, wd = 70, ht = 70, strength = 5, speed = 3, hp = 25000, hpMax = 25000, hpRegen = 5, atk = 20, atkSpeed = 1.0, armor = 3, atkRange = 100, alliance = "a", visionRange = 500, atkType = "melee"))        
