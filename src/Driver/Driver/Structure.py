...
class Tower(Structure, object):
    def __init__(self, **kwds):
        super(Tower, self).__init__(wd = 100, ht = 100, strength = 5, speed = 0, hp = 1000, hpMax = 1000, hpRegen = 0, atk = 50, atkSpeed = 1.0, armor = 5, atkRange = 500, visionRange = 650, atkType = "ranged", projWidth = 25, type = "tower", **kwds)
        self.name = "Tower"
        self.type = "tower"
